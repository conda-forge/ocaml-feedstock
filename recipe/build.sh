...
sed -i "s/\$(MAKE) coldstart/\$(MAKE) CC=${CC_FOR_BUILD} LD=x86_64-apple-darwin13.4.0-ld coldstart/" Makefile
sed -i "s/\$(MAKE) checkstack/\$(MAKE) CC=${CC_FOR_BUILD} LD=x86_64-apple-darwin13.4.0-ld checkstack/" Makefile
